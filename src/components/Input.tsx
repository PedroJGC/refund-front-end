...
export function Input({ legend, ...rest }: Props) {
  return (
    <fieldset className="flex flex-1 max-h-20 text-gray-200 focus-within:text-green-100">
      ...
      <input
        className="w-full h-12 rounded-lg border border-gray-300 px-4 text-sm bg-transparent outline-none focus:border-2 focus:border-green-100 placeholder-gray-300"
        type="text"
        {...rest}
      />
    </fieldset>
